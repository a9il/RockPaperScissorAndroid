...
public class CanvasManager : MonoBehaviour, IPointerClickHandler
{
    ...
    private void StartShowAndCompare()
    {
        ...
        opponentHand.Show(handSprites[(int)submittedHands[1]], OnTurnFinished);
    }
    ...
    public void SetTurnEndedCallback(Action callback)
    {
        _onTurnEnded = callback;
    }
    ...
    {
        leaderboard.DisplayOfflineLeaderboard(playerAndOpponentScore);
        GoToLeaderboard();
    }
